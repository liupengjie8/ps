 ...
 * Generated at: 2019-11-04 10:42:00 UTC
...
static {
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t  <option value =\"团体标准\" selected>团体标准</option>\n");
      out.write("\t\t\t\t\t\t\t  <option value =\"三级评审标准（2018版）\">三级评审标准（2018版）</option>\n");
      out.write("\t\t\t\t\t\t\t  <option value=\"JCI\">JCI</option>\n");
      out.write("\t\t\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\n");
