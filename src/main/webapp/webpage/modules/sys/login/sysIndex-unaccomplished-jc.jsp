        ...
        <div class="right_head">
			<div class="nav_list">
				<ul>
					...
					<li id="m3" class="active"><a  href="/ps/a/unaccomplished/unaccomplished/unaccomplished" target="iframe0">监测报告</a></li>
					<li id="m4"><a href="/ps/a/opedetail/opeDetail/opeDetail" target="iframe0">个案查询</a></li>
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="J_mainContent" id="content-main"
						...
						<iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${ctx}/unaccomplished/unaccomplished/unaccomplished" frameborder="0" data-id="${ctx}/unaccomplished/unaccomplished/unaccomplished" seamless></iframe>
					</div>
				</div>
			</div>
		</div>
