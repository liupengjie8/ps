...
<li><a target="iframe0" class="J_menuItem1" href="/ps/a/indexForm/indexForm/indexForm?fromPage=leftTree&amp;nodeName=适应证评估" data-index="2"><i class="fa null"></i>&nbsp;&nbsp;适应证评估</a></li>
<li><a target="iframe0" class="J_menuItem1" href="/ps/a/indexForm/indexForm/indexForm?fromPage=leftTree&amp;nodeName=等级评估" data-index="3"><i class="fa null"></i>&nbsp;&nbsp;等级评估</a></li>
<li><a target="iframe0" class="J_menuItem1" href="/ps/a/indexForm/indexForm/indexForm?fromPage=leftTree&amp;nodeName=风险评估" data-index="4"><i class="fa null"></i>&nbsp;&nbsp;风险评估</a></li>
</ul>
</li>
<li class="panel">
...
<li><a target="iframe0" class="J_menuItem1" href="/ps/a/indexForm/indexForm/indexForm?fromPage=leftTree&amp;nodeName=术前讨论" data-index="5"><i class="fa null"></i>&nbsp;&nbsp;术前讨论</a></li>
<li><a target="iframe0" class="J_menuItem1" href="/ps/a/indexForm/indexForm/indexForm?fromPage=leftTree&amp;nodeName=知情同意" data-index="6"><i class="fa null"></i>&nbsp;&nbsp;知情同意</a></li>
<li><a target="iframe0" class="J_menuItem1" href="/ps/a/indexForm/indexForm/indexForm?fromPage=leftTree&amp;nodeName=手术安排" data-index="7"><i class="fa null"></i>&nbsp;&nbsp;手术安排</a></li>
</ul>
</li>
<li class="panel">
...
<li><a target="iframe0" class="J_menuItem1" href="/ps/a/indexForm/indexForm/indexForm?fromPage=leftTree&amp;nodeName=术前访视" data-index="8"><i class="fa null"></i>&nbsp;&nbsp;术前访视</a></li>
<li><a target="iframe0" class="J_menuItem1" href="/ps/a/indexForm/indexForm/indexForm?fromPage=leftTree&amp;nodeName=术前医嘱" data-index="9"><i class="fa null"></i>&nbsp;&nbsp;术前医嘱</a></li>
<li><a target="iframe0" class="J_menuItem1" href="/ps/a/indexForm/indexForm/indexForm?fromPage=leftTree&amp;nodeName=器械准备" data-index="10"><i class="fa null"></i>&nbsp;&nbsp;器械准备</a></li>
</ul>
</li>
</ul>
</li>
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="J_mainContent" id="content-main"
						...
						<iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${ctx}/opedetail/opeDetail/opeDetail" frameborder="0" data-id="${ctx}/opedetail/opeDetail/opeDetail" seamless></iframe>
					</div>
				</div>
			</div>
		</div>
