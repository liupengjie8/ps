			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="J_mainContent" id="content-main"
						style="${cookie.tab.value!=false?'height:calc(100%)':'height:calc(100%)'}">
						<iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${ctx}/standmodular/opeStandModular/questionBank" frameborder="0" data-id="${ctx}/standmodular/opeStandModular/questionBank" seamless></iframe>
					</div>
				</div>
			</div>
		</div>
