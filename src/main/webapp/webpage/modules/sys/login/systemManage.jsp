			...
			<div class="side-widgets">
				<div class="widgets-content">
					...
					<%--					<li><a class="J_menuItem" href="/ps/a/standindex/opeStIndex" data-index="5"><i class="fa fa fa-th"></i>&nbsp;&nbsp;指标</a></li>
										<li><a class="J_menuItem" href="/ps/a/preopedetail/preOpePatientIndexRec" data-index="6"><i class="fa fa fa-th"></i>&nbsp;&nbsp;术前明细</a></li>
										<li><a class="J_menuItem" href="/ps/a/opecolumn/opeColumn" data-index="7"><i class="fa fa fa-th"></i>&nbsp;&nbsp;筛选条件维护</a></li>--%>
									</ul>
								</li>
							</ul>
						</div>
