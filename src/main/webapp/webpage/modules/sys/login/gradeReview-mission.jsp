...
<body class="">
	<nav class="navbar topnav-navbar navbar-fixed-top" role="navigation">
        ...
        <div class="right_head" style="margin-left: 0px">
			<div class="nav_list">
				<ul>
					<li id="m1" ><a href="${ctx}/standmodular/opeStandModular/gradeReview" target="iframe2">评测概况</a></li>
					<li id="m3" class="active"><a  href="/ps/a/ope/manageMission" target="iframe2">评测任务</a></li>
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="J_mainContent" id="content-main"
						...
						<iframe class="J_iframe" name="iframe2" width="100%" height="100%" src="${ctx}/ope/manageMission" frameborder="0" data-id="${ctx}/ope/manageMission" seamless></iframe>
					</div>
				</div>
			</div>
		</div>
