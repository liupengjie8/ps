			...
			<div class="panel panel-primary">
				...
				<div class="panel-body" style="height: 1323px">
					<table id="midTable"  style="border-collapse:separate; border-spacing:0px 8px;">
						<tr><td class="tdTest"><input type="radio">2019/10/20日检查任务 9/12</td><td class="td110"><a>编辑 删除</a></td></tr>
						<tr><td class="tdTest"><input type="radio">2019/09/20日检查任务 9/12</td><td class="td110"><a>编辑 删除</a></td></tr>
						<tr><td class="tdTest"><input type="radio">2019/08/20日检查任务 9/12</td><td class="td110"><a>编辑 删除</a></td></tr>
						<tr><td class="tdTest"><input type="radio">2019/07/20日检查任务 9/12</td><td class="td110"><a>编辑 删除</a></td></tr>
						<tr><td class="tdTest"><input type="radio">2019/06/20日检查任务 9/12</td><td class="td110"><a>编辑 删除</a></td></tr>
						<tr><td class="tdTest"><input type="radio">2019/05/20日检查任务 9/12</td><td class="td110"><a>编辑 删除</a></td></tr>
						<tr><td class="tdTest"><input type="radio">2019/04/20日检查任务 9/12</td><td class="td110"><a>编辑 删除</a></td></tr>
						<tr><td class="tdTest"><input type="radio">2019/03/20日检查任务 9/12</td><td class="td110"><a>编辑 删除</a></td></tr>
						<tr><td class="tdTest"><input type="radio">2019/02/20日检查任务 9/12</td><td class="td110"><a>编辑 删除</a></td></tr>
						<tr><td class="tdTest"><input type="radio">2019/01/20日检查任务 9/12</td><td class="td110"><a>编辑 删除</a></td></tr>
						<tr><td class="tdTest"><input type="radio">2018/12/20日检查任务 9/12</td><td class="td110"><a>编辑 删除</a></td></tr>
						<tr><td class="tdTest"><input type="radio">2018/11/20日检查任务 9/12</td><td class="td110"><a>编辑 删除</a></td></tr>
					</table>
				</div>
			</div>
		</div>
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane active" id="all">
							<div class="panel panel-primary" style="height: 300px;margin-left: 10px;margin-top: 10px">
								<div class="panel-body " >
									<h5><img src="${ctxStatic}/common/img/rengong.png">任务名称：急诊流程质量评审<span style="background-color: orange;height: 20px;color: white">人工任务</span></h5>
							...
							<div class="panel panel-primary" style="height: 300px;margin-left: 10px;margin-top: 10px">
								<div class="panel-body " >
									<h5><img src="${ctxStatic}/common/img/zidong.png">任务名称：急诊流程质量评审 <span style="background-color: green;height: 20px;color: white">自动任务</span></h5>
									<table id="midTable"  cellpadding="20px" cellspacing="20px" style="border-collapse:separate; border-spacing:0px 8px;">
										<tr><td class="tdNormal">起始时间：2019/06/14——2019/07/14</td><td class="tdNormal1">分配人：张小龙（院长）</td></tr>
										<tr><td class="tdNormal">执行角色：急诊护士长</td><td class="tdNormal1">负责人：刘建设（副院长）</td></tr>
										<tr><td class="tdNormal">任务描述：评审急诊流程是否完整</td><td class="tdNormal1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↓</td></tr>
