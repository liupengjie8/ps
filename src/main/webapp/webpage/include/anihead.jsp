...
<script  src="${ctxStatic}/plugin/cascadebox/cascadebox.js"></script>
<link  href="${ctxStatic}/plugin/cascadebox/cascadebox.css" rel="stylesheet" />
<script  src="${ctxStatic}/plugin/laydate/laydate.js"></script>
...
<link rel="stylesheet" id="theme" href="${ctxStatic}/common/css/app-${cookie.theme.value==null?'default':cookie.theme.value}.css" />
