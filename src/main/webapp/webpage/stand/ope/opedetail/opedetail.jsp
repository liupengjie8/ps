...
<head>
    ...
    <script type="text/javascript">
        ...
        function confirmSelectIndex() {
			...
			var labels = $(".cascadebox_header label");
			var html="已选指标:";
			labels.each( function(){
				html+=$(this).html();
				html+=",";
			});
			$("#selectIndexSpan").html(html.substr(0,html.length-1));
    ...
    <div class="row">
        <div class="report-page-box">
            <div class="report-page-boxmain">
                <div class="report-page-box" >
                    <div class="bars pull-right-selectarea">
					...
					<span id="selectIndexSpan"></span>
                    <!-- 表格 -->
                    <table id="preOpePatientIndexRecTable" data-toolbar="#toolbar"></table>
                    </div>
                    <input id="showAllOrNotQualified" type="checkbox" checked="false"
                           onclick="showAllOrNotQualified()"/>只显示不达标患者
                </div>
            </div>
        </div>
    </div>
