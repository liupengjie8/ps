	...
	<div class="wrapper wrapper-content"> 
							...
							<div class="col-xs-1-5">
								<div class="form-group">
									<div class="row">
										...
										<div class="col-md-12">
										    <select id='node_select' class="form-control " οnchange="getIndexListByNode()">
		...
		<div class="row" >
			...
			<div class="report-page-boxtop">
				<p>本期，我院有<span id='allcount'>114</span>位患者手术，按时完成手术适应证评估的患者<span id='qcount'>101</span>人，有<span id='nqcount'>13</span>例患者未在规定时间内给以手术适应证评估，适应证评估按时完成率为<span id='qrate'>88.60</span>%。</p>
			</div>
			...
			<div class="report-page-boxmain">
				...
				<div class="report-page-boxright" style="overflow:scroll;">
					
					<h2>各<span id='tmhbm'>科室</span>各<span id='tmzbm'>费别</span><span id='tmzb'>适应症完成率</span></h2>
